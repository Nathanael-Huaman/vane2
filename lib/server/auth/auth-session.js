...
import {
  buildSilentUnauthenticatedSessionResponse,
  isStaticGenerationAuthSessionMiss,
} from "@/lib/server/auth/session-error";
...
export async function getAuthenticatedSession() {
  ...
  try {
    ...
    if (isStaticGenerationAuthSessionMiss(error)) {
      return buildSilentUnauthenticatedSessionResponse();
    }
