...
import { AUTH_FEEDBACK_MESSAGES } from "./feedback";
...
function getSafeAuthError(scope) {
  if (scope === "credentials") return AUTH_FEEDBACK_MESSAGES.credentialsError;
  if (scope === "google") return AUTH_FEEDBACK_MESSAGES.googleError;
  return AUTH_FEEDBACK_MESSAGES.signOutError;
}
